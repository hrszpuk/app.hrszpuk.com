...
function About() {
    return (
        <div className='content'>
            ...
            <p>At Joe's Cheese Shop, we believe that cheese is more than just food; it's an experience. That's why we offer a wide range of services, including cheese tasting sessions, pairing workshops, and personalized cheese boards. Whether you're a cheese novice or a connoisseur, we're here to help you explore and enjoy the wonderful world of cheese. </p>
            <p>Thank you for choosing Joe's Cheese Shop. We look forward to sharing our love of cheese with you!</p>
        </div>
    );
}
